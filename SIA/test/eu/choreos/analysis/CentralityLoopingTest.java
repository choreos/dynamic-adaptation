...
public class CentralityLoopingTest {
	...
	public void setUp() {
		...
		graph = factory.getGraph(TestGraph.LOOP);
		expectedCentrality = factory.getCentralityAnalysis(TestGraph.LOOP);		
	...
	@Test
	public void shouldCalculateVerticesBetweennessCentrality() {
